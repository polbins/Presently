                    ...
                    override fun onAuthenticationError(
                        ...
                        when (errorCode) {
                            ...
                            BiometricConstants.ERROR_LOCKOUT_PERMANENT -> {
                                ...
                                FirebaseCrashlytics.getInstance().recordException(Exception("Permanent Lockout occurred"))
                                requireActivity().finish()
                            }
                            ...
                            BiometricConstants.ERROR_NO_DEVICE_CREDENTIAL -> {
                                FirebaseCrashlytics.getInstance().recordException(Exception(errString.toString()))
                                ...
                                FirebaseCrashlytics.getInstance().recordException(Exception("Code: $errorCode: $errString"))
                                Toast.makeText(
                                        context,
